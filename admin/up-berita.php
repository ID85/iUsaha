                ...
                <div class="col-md-12 graphs">
                    <div class="xs">
                        ...
                        <div class="widget-body">
                            <h3>Publish Berita Keberanda Member</h3>
                            <div class="editor">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <h4>Upload Isi dan Gambar atau Foto</h4>
                            ...
                            <div class="widget-body">
                                <div class="editor">
                                    <div class="upload-right">
                                        <h4>Publish Berita</h4>

                                            <div class="form-group-u">
                                                <input type="text" class="form-control1 input-lg" name="judul_artikel" placeholder="Maasukkan Judul ...">
                                            </div>
                                            <div class="editor-u" >
