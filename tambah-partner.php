...
<html>
<head>
<title>Tambah Partner - iUsaha</title>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<div class="main-grids">
				<div class="top-grids">
					...
					<div class="col-md-4 resent-grid-1-k recommended-grid slider-top-grids">
						<div class="resent-grid-info recommended-grid-info-1-ko">
							<h4>Apakah anda ingin menambahkan <a href="">nama member</a> kedalam partner anda ?</h4>
							<!-- <div class="btn" role="" aria-label="..."> -->
								<button type="button" class="btn btn-default">Tidak</button>
								<button type="button" class="btn btn-default">Ya</button>
							<!-- </div> -->
						</div>
						<div class="resent-grid-info recommended-grid-info-1-k">
							<div class="resent-grid-img-1 recommended-grid-img">
								<img src="images-b/t2.jpg" alt="" />
							</div>
						</div>
						<div class="resent-grid-info recommended-grid-info-1-k">
							<h3><a href="single.html" class="title title-info">Pellentesque vitae pulvinar tortor nullam interdum metus a imperdiet</a>
								<ul>
